    ...
    return (
      <div className="pt-3 flex-shrink-0">
        <motion.button
          ...
          className="w-full h-14 rounded-2xl bg-red-600 active:bg-red-800 transition-colors flex items-center justify-center gap-3 font-semibold text-base shadow-lg shadow-red-500/30"
        >
  ...
  return (
    <div className="pt-3 flex-shrink-0 space-y-2.5">
      <motion.button
        ...
        className={`w-full h-14 rounded-2xl font-semibold text-base flex items-center justify-center gap-3 relative overflow-hidden ${
          isListening
            ? 'bg-purple-600 cursor-not-allowed'
            : 'bg-gradient-to-r from-purple-600 to-blue-600 active:from-purple-700 active:to-blue-700 transition-all shadow-lg shadow-purple-500/30'
        }`}
